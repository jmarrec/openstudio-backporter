...
This projects adheres to [Semantic Versioning](https://semver.org/spec/v2.0.0.html) for bug fix releases (and will likely follows the base OpenStudio SDK versions at some point)
